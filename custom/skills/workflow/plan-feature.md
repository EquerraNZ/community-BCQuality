...
- **Approved-spec precondition** - `specs/features/<id>/spec.md` must exist and be approved with acceptance criteria and open questions resolved. If criteria or open questions are unresolved, planning is premature and `spec-feature` must run first.
